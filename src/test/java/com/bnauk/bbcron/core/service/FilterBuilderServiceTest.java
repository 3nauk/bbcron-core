...
class FilterBuilderServiceTest {
  ...
  void create_filter_condition_not_valid() {
    ...
    assertThrows(
        BadRequestException.class, () -> filterBuilderService.createFilterCondition(criteria));
  }
  ...
  void get_pageable_information() {
    ...
    assertThrows(
        BadRequestException.class, () -> filterBuilderService.getPageable(10, 1, "name|NOT_FOUND"));
  }
